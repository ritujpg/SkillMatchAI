...
export default function Analyze() {
  ...
  const analyze = async () => {
    if (!file || !jobInputValid) {
      setError(tab === "url" ? "Please enter a valid job URL." : "Please add a valid resume image and job description.");
      return;
    }
    ...
    sessionStorage.setItem("skillmatch.analysisInput", JSON.stringify({
